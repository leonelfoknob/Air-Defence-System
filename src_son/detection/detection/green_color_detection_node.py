...
class GreenColorDetectionNode(Node):
    def __init__(self):
        ...
        # Initialize publishers for both topics
        ...
        self.green_mask_pub = self.create_publisher(Image, '/green_mask', 10)  # Publisher for the green mask
        ...
        self.create_subscription(Image, '/camera2/image_raw', self.image_callback, 10)#get image from usb_cam pakage when you run with launch file
    ...
    def image_callback(self, msg):
        ...
        # Publish the Green_mask
        green_mask_msg = self.bridge.cv2_to_imgmsg(Green_mask, encoding="mono8")  # mono8 for grayscale mask
