...
class RedColorDetectionNode(Node):
    def __init__(self):
        ...
        # Initialize publisher for the processed frame and red color center
        ...
        self.create_subscription(Image, '/camera2/image_raw', self.image_callback, 10)#get image from usb_cam pakage when you run with launch
    ...
    def image_callback(self, msg):
        ...
        # Publish the Red_mask
        red_mask_msg = self.bridge.cv2_to_imgmsg(Red_mask, encoding="mono8")  # mono8 for grayscale mask
        self.red_mask_pub.publish(red_mask_msg)
...
class RedColorDetectionNode(Node):
    ...
    def image_callback(self, msg):
        ...
        # Publish the frame with detected red areas
        #image_msg = self.bridge.cv2_to_imgmsg(frame, encoding="bgr8")
        image_msg = self.bridge.cv2_to_imgmsg(Red_mask, encoding="bgr8")
        self.image_pub.publish(image_msg)
